...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
							      [0] = LAYOUT_plaid_mit(
										     ...
										     KC_LCTL, KC_LGUI, KC_LALT, MO(1), MO(2), KC_SPC, KC_RCTL, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
										     ),
							      [1] = LAYOUT_plaid_mit(
										     ...
										     KC_LCTL, KC_LGUI, KC_LALT, KC_NO, KC_NO, KC_SPC, KC_INS, KC_HOME, KC_PGDN, KC_PGUP, KC_END
										     ),
							      [2] = LAYOUT_plaid_mit(
