...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Ctrl | GUI  | Alt  | Lower| Raise|    Space    |Enter | Left | Up   | Down |Right |
     * `-----------------------------------------------------------------------------------'
     */
    [_DEFLT] = LAYOUT( \
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO(_LOWER), MO(_RAISE), KC_SPC, KC_SPC, SFT_T(KC_ENT), KC_LEFT, KC_UP, KC_DOWN, KC_RGHT       \
    ),
