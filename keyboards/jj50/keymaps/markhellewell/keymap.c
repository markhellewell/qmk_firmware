...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
							      [0] = LAYOUT(
									   ...
									   KC_LCTL, KC_LCMD, KC_LALT, KC_RALT, MO(1), KC_SPC, KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
									   ),
                                                              [1] = LAYOUT(
							      ...
							      [2] = LAYOUT(
									   ...
									   KC_LCTL, KC_LCMD, KC_LALT, KC_NO, KC_NO, KC_SPC, KC_SPC, KC_INS, KC_HOME, KC_PGDN, KC_PGUP, KC_END
									   )
};
